...
class Entry
{
  public:
    ...
    enum Sections { 
      ...
      COMPOUNDDOC_MASK = CLASSDOC_SEC | STRUCTDOC_SEC | UNIONDOC_SEC | PREDDOC_SEC |
    ...
    static const uint64 ForwardDecl     = (1ULL<<16); // forward declarad template classes

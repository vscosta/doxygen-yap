...
static const char svgZoomHeader[] =
    "<svg id=\"main\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" "
    ...
    "to=\"#808080\" begin=\"zoomplus.mouseover\" end=\"zoomplus.mouseout\"/>\n"
    "                        </use>\n"
    "                        <path d=\"M-4,0h8M0,-4v8\" fill=\"none\" "
    "stroke=\"white\" stroke-width=\"1.5\" pointer-events=\"none\"/>\n"
    "                </g>\n"
    "                <g id=\"zoomMin\">\n"
    "                        <use xlink:href=\"#rim\" fill=\"#404040\">\n"
    "                                <set attributeName=\"fill\" "
    "to=\"#808080\" begin=\"zoomminus.mouseover\" "
    "end=\"zoomminus.mouseout\"/>\n"
    "                        </use>\n"
    "                        <path d=\"M-4,0h8\" fill=\"none\" "
    "stroke=\"white\" stroke-width=\"1.5\" pointer-events=\"none\"/>\n"
    "                </g>\n"
    "                <g id=\"dirArrow\">\n"
    "                        <path fill=\"none\" stroke=\"white\" "
    "stroke-width=\"1.5\" d=\"M0,-3.0v7 M-2.5,-0.5L0,-3.0L2.5,-0.5\"/>\n"
    "                </g>\n"
    "               <g id=\"resetDef\">\n"
    "                       <use xlink:href=\"#rim2\" fill=\"#404040\">\n"
    "                               <set attributeName=\"fill\" to=\"#808080\" "
    "begin=\"reset.mouseover\" end=\"reset.mouseout\"/>\n"
    "                       </use>\n"
    "               </g>\n"
    "        </defs>\n"
    "\n"
...
static const char svgZoomFooter[] =
    ...
    "fill=\"#404254\">\n"
    "                <rect fill=\"#f2f5e9\" fill-opacity=\"0.5\" "
    "stroke=\"#606060\" stroke-width=\".5\" x=\"0\" y=\"0\" width=\"60\" "
    "height=\"60\"/>\n"
    // zoom in
    "                <use id=\"zoomplus\" xlink:href=\"#zoomPlus\" x=\"17\" "
    "y=\"9\" onmousedown=\"handleZoom(evt,'in')\"/>\n"
    // zoom out
    "                <use id=\"zoomminus\" xlink:href=\"#zoomMin\" x=\"42\" "
    "y=\"9\" onmousedown=\"handleZoom(evt,'out')\"/>\n"
    // reset zoom
    "                <use id=\"reset\" xlink:href=\"#resetDef\" x=\"30\" "
    "y=\"36\" onmousedown=\"handleReset()\"/>\n"
    // arrow up
    "                <g id=\"arrowUp\" xlink:href=\"#dirArrow\" "
    "transform=\"translate(30 24)\" onmousedown=\"handlePan(0,-1)\">\n"
    "                  <use xlink:href=\"#rim\" fill=\"#404040\">\n"
    "                        <set attributeName=\"fill\" to=\"#808080\" "
    "begin=\"arrowUp.mouseover\" end=\"arrowUp.mouseout\"/>\n"
    "                  </use>\n"
    "                  <path fill=\"none\" stroke=\"white\" "
    "stroke-width=\"1.5\" d=\"M0,-3.0v7 M-2.5,-0.5L0,-3.0L2.5,-0.5\"/>\n"
    "                </g>\n"
    // arrow right
    "                <g id=\"arrowRight\" xlink:href=\"#dirArrow\" "
    "transform=\"rotate(90) translate(36 -43)\" "
    "onmousedown=\"handlePan(1,0)\">\n"
    "                  <use xlink:href=\"#rim\" fill=\"#404040\">\n"
    "                        <set attributeName=\"fill\" to=\"#808080\" "
    "begin=\"arrowRight.mouseover\" end=\"arrowRight.mouseout\"/>\n"
    "                  </use>\n"
    "                  <path fill=\"none\" stroke=\"white\" "
    "stroke-width=\"1.5\" d=\"M0,-3.0v7 M-2.5,-0.5L0,-3.0L2.5,-0.5\"/>\n"
    "                </g>\n"
    // arrow down
    "                <g id=\"arrowDown\" xlink:href=\"#dirArrow\" "
    "transform=\"rotate(180) translate(-30 -48)\" "
    "onmousedown=\"handlePan(0,1)\">\n"
    "                  <use xlink:href=\"#rim\" fill=\"#404040\">\n"
    "                        <set attributeName=\"fill\" to=\"#808080\" "
    "begin=\"arrowDown.mouseover\" end=\"arrowDown.mouseout\"/>\n"
    "                  </use>\n"
    "                  <path fill=\"none\" stroke=\"white\" "
    "stroke-width=\"1.5\" d=\"M0,-3.0v7 M-2.5,-0.5L0,-3.0L2.5,-0.5\"/>\n"
    "                </g>\n"
    // arrow left
    "                <g id=\"arrowLeft\" xlink:href=\"#dirArrow\" "
    "transform=\"rotate(270) translate(-36 17)\" "
    "onmousedown=\"handlePan(-1,0)\">\n"
    "                  <use xlink:href=\"#rim\" fill=\"#404040\">\n"
    "                        <set attributeName=\"fill\" to=\"#808080\" "
    "begin=\"arrowLeft.mouseover\" end=\"arrowLeft.mouseout\"/>\n"
    "                  </use>\n"
    "                  <path fill=\"none\" stroke=\"white\" "
    "stroke-width=\"1.5\" d=\"M0,-3.0v7 M-2.5,-0.5L0,-3.0L2.5,-0.5\"/>\n"
    "                </g>\n"
    ...
    "        <svg viewBox=\"0 0 15 15\" width=\"100%\" height=\"30px\" "
    "preserveAspectRatio=\"xMaxYMin meet\">\n"
    "         <g id=\"arrow_out\" transform=\"scale(0.3 0.3)\">\n"
    "          <a xlink:href=\"$orgname\" target=\"_base\">\n"
    "           <rect id=\"button\" ry=\"5\" rx=\"5\" y=\"6\" x=\"6\" "
    "height=\"38\" width=\"38\"\n"
    "                fill=\"#f2f5e9\" fill-opacity=\"0.5\" stroke=\"#606060\" "
    "stroke-width=\"1.0\"/>\n"
    "           <path id=\"arrow\"\n"
    "             d=\"M 11.500037,31.436501 C 11.940474,20.09759 "
    "22.043105,11.32322 32.158766,21.979434 L 37.068811,17.246167 C "
    "37.068811,17.246167 37.088388,32 37.088388,32 L 22.160133,31.978069 C "
    "22.160133,31.978069 26.997745,27.140456 26.997745,27.140456 C "
    "18.528582,18.264221 13.291696,25.230495 11.500037,31.436501 z\"\n"
    "             style=\"fill:#404040;\"/>\n"
    "          </a>\n"
    "         </g>\n"
    "        </svg>\n"
...
static EdgeProperties umlEdgeProps = {umlEdgeColorMap, umlArrowStyleMap,
                                      umlEdgeStyleMap};
...
static void writeGraphHeader(FTextStream &t,
  ...
  t << "  node [fontname=\"" << FONTNAME << "\","
                                            "fontsize=\""
    << FONTSIZE << "\",shape=record];\n";
}

static void writeGraphFooter(FTextStream &t) { t << "}" << endl; }
...
static bool readBoundingBox(const char *fileName, int *width, int *height,
                            bool isEps) {
  QCString bb =
      isEps ? QCString("%%PageBoundingBox:") : QCString("/MediaBox [");
  QFile f(fileName);
  ...
  while (!f.atEnd()) {
    ...
    if (numBytes > 0) {
      ...
      {
        int x, y;
        if (sscanf(p + bb.length(), "%d %d %d %d", &x, &y, width, height) !=
            4) {
    ...
    if (numBytes > 0) {
      ...
      if (qstrncmp(buf, "<!--zoomable ", 13) == 0) {
        ...
        *height = -1;
        ...
        found = TRUE;
      } else if (sscanf(buf, "<svg width=\"%dpt\" height=\"%dpt\"", width,
                        height) == 2) {
        // printf("Found fixed size %dx%d for
...
static void writeSVGNotSupported(FTextStream &out) {
  out << "<p><b>This browser is not able to show SVG: try Firefox, Chrome, "
         "Safari, or Opera instead.</b></p>";
}

// check if a reference to a SVG figure can be written and does so if possible.
// return FALSE if not possible (for instance because the SVG file is not yet
// generated).
static bool writeSVGFigureLink(FTextStream &out, const QCString &relPath,
  ...
  if (width == -1) {
    ...
    out << "<iframe scrolling=\"no\" frameborder=\"0\" src=\"" << relPath
        << baseName << ".svg\" width=\"100%\" height=\"" << height << "\">";
  } else {
    // out << "<object type=\"image/svg+xml\" data=\""
    // out << "<embed type=\"image/svg+xml\" src=\""
    out << "<iframe scrolling=\"no\" frameborder=\"0\" src=\"" << relPath
        << baseName << ".svg\" width=\"" << ((width * 96 + 48) / 72)
        << "\" height=\"" << ((height * 96 + 48) / 72) << "\">";
  }
...
DotRunner::DotRunner(const QCString &file, const QCString &path,
    ...
    : m_dotExe(Config_getString(DOT_PATH) + "dot"), m_file(file), m_path(path),
...
bool DotRunner::run() {
  ...
  if (!m_postCmd.isEmpty() &&
      portable_system(m_postCmd.data(), m_postArgs.data()) != 0) {
...
DotFilePatcher::DotFilePatcher(const char *patchFile) : m_patchFile(patchFile) {
  m_maps.setAutoDelete(TRUE);
}

QCString DotFilePatcher::file() const { return m_patchFile; }
    ...
    if (isSVGFile) {
      if (interactiveSVG) {
        if (line.find("<svg") != -1 && !replacedHeader) {
          int count;
          count = sscanf(line.data(), "<svg width=\"%dpt\" height=\"%dpt\"",
                         &width, &height);
          // printf("width=%d height=%d\n",width,height);
          foundSize = count == 2 && (width > 500 || height > 450);
          if (foundSize)
            insideHeader = TRUE;
        } else if (insideHeader && !replacedHeader &&
                   line.find("<title>") != -1) {
          if (foundSize) {
      ...
      if (n == 1 && mapId >= 0 && mapId < (int)m_maps.count()) {
        ...
        t << "<map name=\"" << map->label << "\" id=\"" << map->label << "\">"
          << endl;
        convertMapFile(t, map->mapFile, map->relPath, map->urlOnly,
                       map->context);
        t << "</map>" << endl;
      } else // error invalid map id!
      {
...
DotWorkerThread::DotWorkerThread(DotRunnerQueue *queue) : m_queue(queue) {
...
DotManager::~DotManager() { delete m_queue; }

void DotManager::addRun(DotRunner *run) { m_dotRuns.append(run); }
...
DotNode::DotNode(int n, const char *lab, const char *tip, const char *url,
    ...
    : m_subgraphId(-1), m_number(n), m_label(lab), m_tooltip(tip), m_url(url),
      m_parents(0), m_children(0), m_edgeInfo(0), m_deleted(FALSE),
      m_written(FALSE), m_hasDoc(FALSE), m_isRoot(isRoot), m_classDef(cd),
...
void DotNode::addChild(DotNode *n, int edgeColor, int edgeStyle,
                       const char *edgeLab, const char *edgeURL,
                       int edgeLabCol) {
  if (m_children == 0) {
...
void DotNode::deleteNode(DotNodeList &deletedList, SDict<DotNode> *skipNodes) {
  ...
  // printf("skipNodes=%p find(%p)=%p\n",skipNodes,this,skipNodes ?
  // skipNodes->find((int)this) : 0);
...
static void writeBoxMemberList(FTextStream &t, char prot, MemberList *ml,
                               ClassDef *scope, bool isStatic = FALSE,
  ...
  if (ml) {
    ...
    for (mlia.toFirst(); (mma = mlia.current()); ++mlia) {
      if (mma->getClassDef() == scope &&
        ...
        if (limit > 0 && (totalCount > limit * 3 / 2 && count >= limit)) {
          t << theTranslator->trAndMore(
                   QCString().sprintf("%d", totalCount - count))
            << "\\l";
          break;
        } else {
          t << prot << " ";
    ...
    if (mgl) {
      ...
      for (mgli.toFirst(); (mg = mgli.current()); ++mgli) {
        if (mg->members()) {
          writeBoxMemberList(t, prot, mg->members(), scope, isStatic,
                             skipNames);
        }
      }
    }
...
void DotNode::writeBox(FTextStream &t, GraphType gt,
  ...
  if (m_classDef && umlLook && (gt == Inheritance || gt == Collaboration)) {
    ...
    if (m_edgeInfo) {
      ...
      for (li.toFirst(); (ei = li.current()); ++li) {
        if (!ei->m_label.isEmpty()) // labels joined by \n
        {
          ...
          lab = stripProtectionPrefix(
              ei->m_label.right(ei->m_label.length() - p));
          arrowNames.insert(lab, (void *)0x8);
        }
      }
    }
    ...
    t << "\\n|";
    writeBoxMemberList(t, '+',
                       m_classDef->getMemberList(MemberListType_pubAttribs),
                       m_classDef, FALSE, &arrowNames);
    writeBoxMemberList(
        t, '+', m_classDef->getMemberList(MemberListType_pubStaticAttribs),
        m_classDef, TRUE, &arrowNames);
    writeBoxMemberList(t, '+',
                       m_classDef->getMemberList(MemberListType_properties),
                       m_classDef, FALSE, &arrowNames);
    writeBoxMemberList(t, '~',
                       m_classDef->getMemberList(MemberListType_pacAttribs),
                       m_classDef, FALSE, &arrowNames);
    writeBoxMemberList(
        t, '~', m_classDef->getMemberList(MemberListType_pacStaticAttribs),
        m_classDef, TRUE, &arrowNames);
    writeBoxMemberList(t, '#',
                       m_classDef->getMemberList(MemberListType_proAttribs),
                       m_classDef, FALSE, &arrowNames);
    writeBoxMemberList(
        t, '#', m_classDef->getMemberList(MemberListType_proStaticAttribs),
        m_classDef, TRUE, &arrowNames);
    if (extractPrivate) {
      writeBoxMemberList(t, '-',
                         m_classDef->getMemberList(MemberListType_priAttribs),
                         m_classDef, FALSE, &arrowNames);
      writeBoxMemberList(
          t, '-', m_classDef->getMemberList(MemberListType_priStaticAttribs),
          m_classDef, TRUE, &arrowNames);
    }
    t << "|";
    writeBoxMemberList(t, '+',
                       m_classDef->getMemberList(MemberListType_pubMethods),
                       m_classDef);
    writeBoxMemberList(
        t, '+', m_classDef->getMemberList(MemberListType_pubStaticMethods),
        m_classDef, TRUE);
    writeBoxMemberList(
        t, '+', m_classDef->getMemberList(MemberListType_pubSlots), m_classDef);
    writeBoxMemberList(t, '~',
                       m_classDef->getMemberList(MemberListType_pacMethods),
                       m_classDef);
    writeBoxMemberList(
        t, '~', m_classDef->getMemberList(MemberListType_pacStaticMethods),
        m_classDef, TRUE);
    writeBoxMemberList(t, '#',
                       m_classDef->getMemberList(MemberListType_proMethods),
                       m_classDef);
    writeBoxMemberList(
        t, '#', m_classDef->getMemberList(MemberListType_proStaticMethods),
        m_classDef, TRUE);
    writeBoxMemberList(
        t, '#', m_classDef->getMemberList(MemberListType_proSlots), m_classDef);
    if (extractPrivate) {
      writeBoxMemberList(t, '-',
                         m_classDef->getMemberList(MemberListType_priMethods),
                         m_classDef);
      writeBoxMemberList(
          t, '-', m_classDef->getMemberList(MemberListType_priStaticMethods),
          m_classDef, TRUE);
      writeBoxMemberList(t, '-',
                         m_classDef->getMemberList(MemberListType_priSlots),
                         m_classDef);
    }
    if (m_classDef->getLanguage() != SrcLangExt_Fortran &&
      ...
      for (mgdi.toFirst(); (mg = mgdi.current()); ++mgdi) {
        if (mg->members()) {
          writeBoxMemberList(t, '*', mg->members(), m_classDef, FALSE,
                             &arrowNames);
        }
      }
    }
  ...
  if (m_isRoot) {
    t << ",color=\"black\", fillcolor=\"grey75\", style=\"filled\", "
         "fontcolor=\"black\"";
  } else {
...
void DotNode::writeArrow(FTextStream &t, GraphType gt, GraphOutputFormat format,
                         DotNode *cn, EdgeInfo *ei, bool topDown,
                         bool pointBack) {
  t << "  Node";
  if (topDown)
    t << cn->number();
  ...
  if (pointBack && !umlUseArrow)
    t << "dir=\"back\",";
  t << "color=\"" << eProps->edgeColorMap[ei->m_color] << "\",fontsize=\""
    << FONTSIZE << "\",";
...
void DotNode::write(FTextStream &t, GraphType gt, GraphOutputFormat format,
    ...
    } else // render parents
    {
      ...
      for (dnli.toFirst(); (pn = dnli.current()); ++dnli) {
        if (pn->isVisible()) {
          ...
          writeArrow(t, gt, format, pn,
                     pn->m_edgeInfo->at(pn->m_children->findRef(this)), FALSE,
                     backArrows);
        }
...
void DotNode::writeXML(FTextStream &t, bool isClassGraph) {
  ...
  if (m_children) {
    ...
    for (; (childNode = nli.current()); ++nli, ++eli) {
      ...
      t << "        <childnode refid=\"" << childNode->m_number
        << "\" relation=\"";
      if (isClassGraph) {
      ...
      if (!edgeInfo->m_label.isEmpty()) {
        ...
        while ((ni = edgeInfo->m_label.find('\n', p)) != -1) {
          t << "          <edgelabel>"
            << convertToXML(edgeInfo->m_label.mid(p, ni - p)) << "</edgelabel>"
            << endl;
          p = ni + 1;
        }
        t << "          <edgelabel>" << convertToXML(edgeInfo->m_label.right(
                                            edgeInfo->m_label.length() - p))
          << "</edgelabel>" << endl;
      }
      t << "        </childnode>" << endl;
    }
  ...
  if (!m_url.isEmpty()) {
    ...
    if (urlPtr) {
      *urlPtr++ = '\0';
      ...
      if (*refPtr != '\0') {
        t << "  " << nodePrefix << "link-external = '" << refPtr << "';"
          << endl;
      }
      t << "        };" << endl;
    }
...
void DotGfxHierarchyTable::createGraph(DotNode *n, FTextStream &out,
  ...
  if (checkAndUpdateMd5Signature(absBaseName, sigStr) ||
    ...
    DotRunner *dotRun =
        new DotRunner(dotName, d.absPath().data(), TRUE, absImgName);
  ...
  {
    if (regenerate ||
        !writeSVGFigureLink(out, QCString(), baseName, absImgName)) {
      if (regenerate) {
        DotManager::instance()->addSVGConversion(absImgName, QCString(), FALSE,
                                                 QCString(), FALSE, 0);
      }
  ...
  } else // normal bitmap
  {
    ...
    if (regenerate || !insertMapFile(out, absMapName, QCString(), mapLabel)) {
      int mapId = DotManager::instance()->addMap(
          fileName, absMapName, QCString(), FALSE, QCString(), mapLabel);
      out << "<!-- MAP " << mapId << " -->" << endl;
    }
  }
}

void DotGfxHierarchyTable::writeGraph(FTextStream &out, const char *path,
...
void DotGfxHierarchyTable::addHierarchy(DotNode *n, ClassDef *cd,
  ...
  if (cd->subClasses()) {
    ...
    for (; (bcd = bcli.current()); ++bcli) {
      ...
      // printf("  Trying sub class=`%s'
      // usedNodes=%d\n",bClass->name().data(),m_usedNodes->count());
      if (bClass->isVisibleInHierarchy() &&
          hasVisibleRoot(bClass->baseClasses())) {
        DotNode *bn;
        ...
        {
          if (n->m_children == 0 ||
              n->m_children->findRef(bn) == -1) // no arrow yet
          {
          ...
          bn = new DotNode(m_curNodeNumber++, bClass->displayName(), tooltip,
                           tmp_url.data());
          n->addChild(bn, bcd->prot);
          bn->addParent(n);
...
void DotGfxHierarchyTable::addClassList(ClassSDict *cl) {
  ...
  for (cli.toLast(); (cd = cli.current()); --cli) {
        ...
        cd->isVisibleInHierarchy()) // root node in the forest
    {
      ...
      DotNode *n = new DotNode(m_curNodeNumber++, cd->displayName(), tooltip,
                               tmp_url.data());
...
void DotClassGraph::addClass(ClassDef *cd, DotNode *n, int prot,
                             const char *label, const char *usedName,
                             const char *templSpec, bool base, int distance) {
  if (Config_getBool(HIDE_UNDOC_CLASSES) && !cd->isLinkable())
    return;

  int edgeStyle =
      (label || prot == EdgeInfo::Orange || prot == EdgeInfo::Orange2)
          ? EdgeInfo::Dashed
          : EdgeInfo::Solid;
  QCString className;
  if (cd->isAnonymous()) {
  ...
  } else // new class
  {
    ...
    QCString tooltip = cd->briefDescriptionAsTooltip();
    bn = new DotNode(m_curNodeNumber++, displayName, tooltip, tmp_url.data(),
                     FALSE, // rootNode
                     cd);
    if (base) {
      n->addChild(bn, prot, edgeStyle, label);
...
bool DotClassGraph::determineVisibleNodes(DotNode *rootNode, int maxNodes,
                                          bool includeParents) {
  ...
  bool firstNode =
      TRUE; // flag to force reprocessing rootNode in the parent loop
  ...
  while ((childQueue.count() > 0 || parentQueue.count() > 0) && maxNodes > 0) {
    ...
    if (includeParents && parentQueue.count() > 0) {
      ...
      if ((!n->isVisible() || firstNode) &&
          n->distance() <= maxDistance) // not yet processed
      {
        firstNode = FALSE;
        int distance = n->distance();
        if (distance > 0) {
          ...
          if (distance > oldSize) {
            parentTreeWidth.resize(
                QMAX(parentTreeWidth.size(), (uint)distance));
            int i;
            for (i = oldSize; i < distance; i++)
              parentTreeWidth[i] = 0;
          }
  ...
  return maxWidth > 80 &&
         maxHeight < 12; // used metric to decide to render the tree
...
void DotClassGraph::buildGraph(ClassDef *cd, DotNode *n, bool base,
  ...
  if (m_graphType == DotNode::Inheritance ||
      m_graphType == DotNode::Collaboration) {
  ...
  if (m_graphType == DotNode::Collaboration) {
    ...
    UsesClassDict *dict = base ? cd->usedImplementationClasses()
  ...
  if (templateRelations && base) {
    ...
    if (dict) {
      ...
      for (; (ccd = ccdi.current()); ++ccdi) {
        ...
        // printf("addClass: %s
        // templSpec=%s\n",ucd->classDef->name().data(),ucd->templSpecifiers.data());
        addClass(ccd->classDef, n, EdgeInfo::Orange2, label, 0, 0, TRUE,
                 distance);
      }
    }
  }
  ...
  if (templateRelations) {
    if (base) // template relations for base classes
    {
      ...
      if (templMaster) {
        ...
        for (; (templInstance = cli.current()); ++cli) {
          if (templInstance == cd) {
            addClass(templMaster, n, EdgeInfo::Orange, cli.currentKey(), 0, 0,
                     TRUE, distance);
          }
        }
      }
    } else // template relations for super classes
    {
      ...
      if (templInstances) {
        ...
        ClassDef *templInstance;
        for (; (templInstance = cli.current()); ++cli) {
          addClass(templInstance, n, EdgeInfo::Orange, cli.currentKey(), 0, 0,
                   FALSE, distance);
        }
      }
    }
...
void DotClassGraph::resetNumbering() { m_curNodeNumber = 0; }

DotClassGraph::DotClassGraph(ClassDef *cd, DotNode::GraphType t) {
  // printf("--------------- DotClassGraph::DotClassGraph
  // `%s'\n",cd->displayName().data());
  m_graphType = t;
  QCString tmp_url = "";
  if (cd->isLinkable() && !cd->isHidden()) {
  ...
  QCString tooltip = cd->briefDescriptionAsTooltip();
  m_startNode =
      new DotNode(m_curNodeNumber++, className, tooltip, tmp_url.data(),
                  TRUE, // is a root node
                  cd);
  ...
  m_lrRank =
      determineVisibleNodes(m_startNode, maxNodes, t == DotNode::Inheritance);
 ...
 */
QCString computeMd5Signature(DotNode *root, DotNode::GraphType gt,
                             GraphOutputFormat format, bool lrRank,
                             bool renderParents, bool backArrows,
                             const QCString &title, QCString &graphStr) {
  ...
  root->clearWriteFlag();
  root->write(md5stream, gt, format,
              gt != DotNode::CallGraph && gt != DotNode::Dependency, TRUE,
              backArrows);
...
static bool updateDotGraph(DotNode *root, DotNode::GraphType gt,
                           const QCString &baseName, GraphOutputFormat format,
                           bool lrRank, bool renderParents, bool backArrows,
                           const QCString &title = QCString()) {
  QCString theGraph;
  // TODO: write graph to theGraph, then compute md5 checksum
  QCString md5 = computeMd5Signature(root, gt, format, lrRank, renderParents,
  ...
  return checkAndUpdateMd5Signature(baseName,
                                    md5); // graph needs to be regenerated
}
...
QCString DotClassGraph::writeGraph(FTextStream &out,
                                   ...
                                   const char *path, const char *fileName,
                                   const char *relPath, bool /*isTBRank*/,
  ...
  bool regenerate = FALSE;
  if (updateDotGraph(m_startNode, m_graphType, absBaseName, graphFormat,
                     m_lrRank, m_graphType == DotNode::Inheritance, TRUE,
                     m_startNode->label()) ||
      !checkDeliverables(
          graphFormat == GOF_BITMAP ? absImgName
                                    : usePDFLatex ? absPdfName : absEpsName,
          graphFormat == GOF_BITMAP && generateImageMap ? absMapName
                                                        : QCString())) {
    regenerate = TRUE;
    if (graphFormat == GOF_BITMAP) // run dot to create a bitmap image
    {
      DotRunner *dotRun =
          new DotRunner(absDotName, d.absPath().data(), TRUE, absImgName);
      dotRun->addJob(imgFmt, absImgName);
      if (generateImageMap)
        dotRun->addJob(MAP_CMD, absMapName);
      DotManager::instance()->addRun(dotRun);
  ...
  if (graphFormat == GOF_BITMAP && textFormat == EOF_DocBook) {
    ...
    out << "                <imagedata";
    out << " width=\"50%\" align=\"center\" valign=\"middle\" scalefit=\"1\" "
           "fileref=\""
        << relPath << baseName << "." << imgExt << "\">";
    out << "</imagedata>" << endl;
    out << "            </imageobject>" << endl;
    out << "        </mediaobject>" << endl;
    out << "    </figure>" << endl;
    out << "</para>" << endl;
  } else if (graphFormat == GOF_BITMAP &&
             generateImageMap) // produce HTML to include the image
  {
    ...
    if (imgExt == "svg") // add link to SVG file without map file
    {
      ...
      if (regenerate ||
          !writeSVGFigureLink(
              ...
              absImgName)) // need to patch the links in the generated SVG file
      {
        if (regenerate) {
          DotManager::instance()->addSVGConversion(absImgName, relPath, FALSE,
                                                   QCString(), TRUE, graphId);
        }
        int mapId = DotManager::instance()->addSVGObject(fileName, baseName,
                                                         absImgName, relPath);
        out << "<!-- SVG " << mapId << " -->" << endl;
    ...
    {
      out << "<div class=\"center\">";
      out << "<img src=\"" << relPath << baseName << "." << imgExt
          << "\" border=\"0\" usemap=\"#" << mapLabel << "\" alt=\"";
      switch (m_graphType) {
      case DotNode::Collaboration:
        out << "Collaboration graph";
        break;
      ...
      if (regenerate || !insertMapFile(out, absMapName, relPath, mapLabel)) {
        int mapId = DotManager::instance()->addMap(
            fileName, absMapName, relPath, FALSE, QCString(), mapLabel);
        out << "<!-- MAP " << mapId << " -->" << endl;
      }
    }
  } else if (graphFormat == GOF_EPS) // produce tex to include the .eps image
  {
    if (regenerate || !writeVecGfxFigure(out, baseName, absBaseName)) {
      int figId = DotManager::instance()->addFigure(
          fileName, baseName, absBaseName, FALSE /*TRUE*/);
    ...
    for (; (ii = ili.current()); ++ili) {
      ...
      if (doc || src || !Config_getBool(HIDE_UNDOC_RELATIONS)) {
        ...
        if (bn) // file is already a node in the graph
        {
          ...
          bn = new DotNode(m_curNodeNumber++, // n
...
void DotInclDepGraph::resetNumbering() { m_curNodeNumber = 0; }
...
DotInclDepGraph::DotInclDepGraph(FileDef *fd, bool inverse) {
  ...
  m_startNode =
      new DotNode(m_curNodeNumber++, fd->docName(), "", tmp_url.data(),
                  TRUE // root node
                  );
  m_startNode->setDistance(0);
  m_usedNodes = new QDict<DotNode>(1009);
...
QCString DotInclDepGraph::writeGraph(FTextStream &out,
  ...
  bool regenerate = FALSE;
  if (updateDotGraph(m_startNode, DotNode::Dependency, absBaseName, graphFormat,
                     FALSE,     // lrRank
                     FALSE,     // renderParents
  ...
  if (graphFormat == GOF_BITMAP && textFormat == EOF_DocBook) {
    ...
    } else // bitmap graphics
    {
      out << "<div class=\"center\"><img src=\"" << relPath << baseName << "."
          << imgExt << "\" border=\"0\" usemap=\"#" << mapName
          << "\" alt=\"\"/>";
      out << "</div>" << endl;
      ...
      if (regenerate || !insertMapFile(out, absMapName, relPath, mapName)) {
        int mapId = DotManager::instance()->addMap(
            fileName, absMapName, relPath, FALSE, QCString(), mapName);
        out << "<!-- MAP " << mapId << " -->" << endl;
      }
    }
  ...
  {
    if (regenerate || !writeVecGfxFigure(out, baseName, absBaseName)) {
      int figId = DotManager::instance()->addFigure(fileName, baseName,
                                                    absBaseName, FALSE);
      out << endl << "% FIG " << figId << endl;
    }
  }
...
bool DotInclDepGraph::isTrivial() const { return m_startNode->m_children == 0; }
...
void DotCallGraph::buildGraph(DotNode *n, MemberDef *md, int distance) {
  MemberSDict *refs =
      m_inverse ? md->getReferencedByMembers() : md->getReferencesMembers();
  if (refs) {
    ...
    for (; (rmd = mri.current()); ++mri) {
      if (rmd->showInCallGraph()) {
        QCString uniqueId;
        uniqueId = rmd->getReference() + "$" + rmd->getOutputFileBase() + "#" +
                   rmd->anchor();
        ...
        if (bn) // file is already a node in the graph
        {
          ...
          QCString name;
          if (Config_getBool(HIDE_SCOPE_NAMES)) {
            name = rmd->getOuterScope() == m_scope ? rmd->name()
                                                   : rmd->qualifiedName();
          } else {
          ...
          bn = new DotNode(m_curNodeNumber++,
                           linkToText(rmd->getLanguage(), name, FALSE), tooltip,
                           uniqueId,
                           0 // distance
                           );
          n->addChild(bn, 0, 0, 0);
...
void DotCallGraph::resetNumbering() { m_curNodeNumber = 0; }
...
DotCallGraph::DotCallGraph(MemberDef *md, bool inverse) {
  ...
  QCString uniqueId;
  uniqueId =
      md->getReference() + "$" + md->getOutputFileBase() + "#" + md->anchor();
  QCString name;
  if (Config_getBool(HIDE_SCOPE_NAMES)) {
    name = md->name();
  } else {
  ...
  m_startNode =
      new DotNode(m_curNodeNumber++, linkToText(md->getLanguage(), name, FALSE),
                  "", uniqueId.data(),
                  TRUE // root node
                  );
  m_startNode->setDistance(0);
...
QCString DotCallGraph::writeGraph(FTextStream &out,
                                  GraphOutputFormat graphFormat,
                                  EmbeddedOutputFormat textFormat,
                                  const char *path, const char *fileName,
                                  const char *relPath, bool generateImageMap,
  ...
  if (graphFormat == GOF_BITMAP && textFormat == EOF_DocBook) {
    ...
    {
      out << "<div class=\"center\"><img src=\"" << relPath << baseName << "."
          << imgExt << "\" border=\"0\" usemap=\"#" << mapName << "\" alt=\"";
      out << "\"/>";
      out << "</div>" << endl;
...
bool DotCallGraph::isTrivial() const { return m_startNode->m_children == 0; }
...
QCString DotDirDeps::writeGraph(FTextStream &out, GraphOutputFormat graphFormat,
                                EmbeddedOutputFormat textFormat,
                                const char *path, const char *fileName,
                                const char *relPath, bool generateImageMap,
                                int graphId, bool linkRelations) const {
  QDir d(path);
  // store the original directory
  if (!d.exists()) {
    err("Output dir %s does not exist!\n", path);
  ...
  if (graphFormat == GOF_BITMAP && textFormat == EOF_DocBook) {
    ...
    } else // bitmap graphics
    {
      ...
      if (regenerate || !insertMapFile(out, absMapName, relPath, mapName)) {
        int mapId = DotManager::instance()->addMap(
            fileName, absMapName, relPath, TRUE, QCString(), mapName);
        out << "<!-- MAP " << mapId << " -->" << endl;
      }
    }
  } else if (graphFormat == GOF_EPS) {
...
bool DotDirDeps::isTrivial() const { return m_dir->depGraphIsTrivial(); }
...
void generateGraphLegend(const char *path) {
  ...
  md5stream
      ...
      << FONTSIZE << "\",style=\"solid\",fontname=\"" << FONTNAME << "\"];\n";
  md5stream << "  Node10 [shape=\"box\",label=\"PublicBase\",fontsize=\""
            << FONTSIZE << "\",height=0.2,width=0.4,fontname=\"" << FONTNAME
            << "\",color=\"black\",URL=\"$classPublicBase"
            << Doxygen::htmlFileExtension << "\"];\n";
  md5stream
      << "  Node11 -> Node10 [dir=\"back\",color=\"midnightblue\",fontsize=\""
      << FONTSIZE << "\",style=\"solid\",fontname=\"" << FONTNAME << "\"];\n";
  md5stream << "  Node11 [shape=\"box\",label=\"Truncated\",fontsize=\""
            << FONTSIZE << "\",height=0.2,width=0.4,fontname=\"" << FONTNAME
            << "\",color=\"red\",URL=\"$classTruncated"
            << Doxygen::htmlFileExtension << "\"];\n";
  md5stream << "  Node13 -> Node9 [dir=\"back\",color=\"darkgreen\",fontsize=\""
            << FONTSIZE << "\",style=\"solid\",fontname=\"" << FONTNAME
            << "\"];\n";
  md5stream << "  Node13 [shape=\"box\",label=\"ProtectedBase\",fontsize=\""
            << FONTSIZE << "\",height=0.2,width=0.4,fontname=\"" << FONTNAME
            << "\",color=\"black\",URL=\"$classProtectedBase"
            << Doxygen::htmlFileExtension << "\"];\n";
  md5stream
      << "  Node14 -> Node9 [dir=\"back\",color=\"firebrick4\",fontsize=\""
      << FONTSIZE << "\",style=\"solid\",fontname=\"" << FONTNAME << "\"];\n";
  md5stream << "  Node14 [shape=\"box\",label=\"PrivateBase\",fontsize=\""
            << FONTSIZE << "\",height=0.2,width=0.4,fontname=\"" << FONTNAME
            << "\",color=\"black\",URL=\"$classPrivateBase"
            << Doxygen::htmlFileExtension << "\"];\n";
  md5stream
      << "  Node15 -> Node9 [dir=\"back\",color=\"midnightblue\",fontsize=\""
      << FONTSIZE << "\",style=\"solid\",fontname=\"" << FONTNAME << "\"];\n";
  md5stream << "  Node15 [shape=\"box\",label=\"Undocumented\",fontsize=\""
            << FONTSIZE << "\",height=0.2,width=0.4,fontname=\"" << FONTNAME
            << "\",color=\"grey75\"];\n";
  md5stream
      << "  Node16 -> Node9 [dir=\"back\",color=\"midnightblue\",fontsize=\""
      << FONTSIZE << "\",style=\"solid\",fontname=\"" << FONTNAME << "\"];\n";
  md5stream << "  Node16 [shape=\"box\",label=\"Templ< int >\",fontsize=\""
            << FONTSIZE << "\",height=0.2,width=0.4,fontname=\"" << FONTNAME
            << "\",color=\"black\",URL=\"$classTempl"
            << Doxygen::htmlFileExtension << "\"];\n";
  md5stream << "  Node17 -> Node16 [dir=\"back\",color=\"orange\",fontsize=\""
            << FONTSIZE << "\",style=\"dashed\",label=\"< int >\",fontname=\""
            << FONTNAME << "\"];\n";
  md5stream << "  Node17 [shape=\"box\",label=\"Templ< T >\",fontsize=\""
            << FONTSIZE << "\",height=0.2,width=0.4,fontname=\"" << FONTNAME
            << "\",color=\"black\",URL=\"$classTempl"
            << Doxygen::htmlFileExtension << "\"];\n";
  md5stream
      << "  Node18 -> Node9 [dir=\"back\",color=\"darkorchid3\",fontsize=\""
      << FONTSIZE << "\",style=\"dashed\",label=\"m_usedClass\",fontname=\""
      << FONTNAME << "\"];\n";
  md5stream << "  Node18 [shape=\"box\",label=\"Used\",fontsize=\"" << FONTSIZE
            << "\",height=0.2,width=0.4,fontname=\"" << FONTNAME
            << "\",color=\"black\",URL=\"$classUsed"
            << Doxygen::htmlFileExtension << "\"];\n";
  writeGraphFooter(md5stream);
  uchar md5_sig[16];
  QCString sigStr(33);
  ...
  if (imgExt == "svg") {
    DotManager::instance()->addSVGObject(
        absBaseName + Config_getString(HTML_FILE_EXTENSION), "graph_legend",
        absImgName, QCString());
  }
}
...
void writeDotGraphFromFile(const char *inFile, const char *outDir,
  ...
  if (format == GOF_BITMAP)
    checkDotResult(getDotImageExtension(), absImgName);
 ...
 */
void writeDotImageMapFromFile(FTextStream &t, const QCString &inFile,
  ...
  {
    t << "<img src=\"" << relPath << imgName << "\" alt=\"" << imgName
      << "\" border=\"0\" usemap=\"#" << mapName << "\"/>" << endl
...
void DotGroupCollaboration::resetNumbering() { m_curNodeNumber = 0; }

DotGroupCollaboration::DotGroupCollaboration(GroupDef *gd) {
  QCString tmp_url = gd->getReference() + "$" + gd->getOutputFileBase();
  m_usedNodes = new QDict<DotNode>(1009);
  m_rootNode =
      new DotNode(m_curNodeNumber++, gd->groupTitle(), "", tmp_url, TRUE);
...
DotGroupCollaboration::~DotGroupCollaboration() { delete m_usedNodes; }
  ...
  if (groups) {
    ...
    for (gli.toFirst(); (d = gli.current()); ++gli) {
      ...
      if (!nnode) { // add node
        ...
        nnode =
            new DotNode(m_curNodeNumber++, d->groupTitle(), tooltip, tmp_url);
        nnode->markAsVisible();
        m_usedNodes->insert(d->name(), nnode);
      }
      tmp_url = "";
      addEdge(nnode, m_rootNode, DotGroupCollaboration::thierarchy, tmp_url,
              tmp_url);
    }
  }
  ...
  if (gd->getSubGroups() && gd->getSubGroups()->count()) {
    ...
    for (; (def = defli.current()); ++defli) {
      ...
      if (!nnode) { // add node
        ...
        nnode =
            new DotNode(m_curNodeNumber++, def->groupTitle(), tooltip, tmp_url);
        nnode->markAsVisible();
        m_usedNodes->insert(def->name(), nnode);
      }
      tmp_url = "";
      addEdge(m_rootNode, nnode, DotGroupCollaboration::thierarchy, tmp_url,
              tmp_url);
    }
  }
...
void DotGroupCollaboration::addMemberList(MemberList *ml) {
  ...
  MemberDef *def;
  for (; (def = defli.current()); ++defli) {
    QCString tmp_url = def->getReference() + "$" + def->getOutputFileBase() +
                       Doxygen::htmlFileExtension + "#" + def->anchor();
    addCollaborationMember(def, tmp_url, DotGroupCollaboration::tmember);
  }
}

DotGroupCollaboration::Edge *
DotGroupCollaboration::addEdge(DotNode *_pNStart, DotNode *_pNEnd,
                               EdgeType _eType, const QCString &_label,
                               const QCString &_url) {
  // search a existing link.
  QListIterator<Edge> lli(m_edges);
  Edge *newEdge = 0;
  for (lli.toFirst(); (newEdge = lli.current()); ++lli) {
    if (newEdge->pNStart == _pNStart && newEdge->pNEnd == _pNEnd &&
        newEdge->eType == _eType) { // edge already found
      break;
    }
  }
  ...
  for (; (d = gli.current()); ++gli) {
    ...
    if (nnode != m_rootNode) {
      if (nnode == 0) { // add node
        ...
        QCString tooltip = d->briefDescriptionAsTooltip();
        nnode =
            new DotNode(m_curNodeNumber++, d->groupTitle(), tooltip, tmp_str);
        nnode->markAsVisible();
        m_usedNodes->insert(d->name(), nnode);
      }
...
QCString DotGroupCollaboration::writeGraph(
    FTextStream &t, GraphOutputFormat graphFormat,
    EmbeddedOutputFormat textFormat, const char *path, const char *fileName,
    const char *relPath, bool writeImageMap, int graphId) const {
  QDir d(path);
  // store the original directory
  if (!d.exists()) {
    err("Output dir %s does not exist!\n", path);
  ...
  if (graphFormat == GOF_BITMAP && textFormat == EOF_DocBook) {
    ...
    t << "            <imageobject>" << endl;
    t << "                <imagedata";
    t << " width=\"50%\" align=\"center\" valign=\"middle\" scalefit=\"1\" "
         "fileref=\""
      << relPath << baseName << "." << imgExt << "\">";
    t << "</imagedata>" << endl;
    t << "            </imageobject>" << endl;
    ...
    if (imgExt == "svg") {
      ...
      t << "<img src=\"" << relPath << imgName
        << "\" border=\"0\" alt=\"\" usemap=\"#" << mapLabel << "\"/>" << endl;
...
void DotGroupCollaboration::Edge::write(FTextStream &t) const {
  const char *linkTypeColor[] = {"darkorchid3", "orange",     "blueviolet",
                                 "darkgreen",   "firebrick4", "grey75",
                                 "midnightblue"};
  ...
  if (links.count() > 0) // there are links
  {
    ...
    for (lli.toFirst(); (link = lli.current()) && count < maxLabels;
         ++lli, ++count) {
      if (first)
        first = FALSE;
      else
...
void writeDotDirDepGraph(FTextStream &t, DirDef *dd, bool linkRelations) {
  ...
  t << "  node [ fontsize=\"" << FONTSIZE << "\", fontname=\"" << FONTNAME
    << "\"];\n";
  t << "  edge [ labelfontsize=\"" << FONTSIZE << "\", labelfontname=\""
    << FONTNAME << "\"];\n";
  ...
  if (dd->parent()) {
    ...
    t << "    graph [ bgcolor=\"#ddddee\", pencolor=\"black\", label=\""
      << dd->parent()->shortName() << "\" fontname=\"" << FONTNAME
  ...
  if (dd->isCluster()) {
    ...
    for (sdi.toFirst(); (sdir = sdi.current()); ++sdi) {
      ...
      t << " URL=\"" << sdir->getOutputFileBase() << Doxygen::htmlFileExtension
        << "\"";
      t << "];\n";
  ...
  // for each used dir (=directly used or a parent of a directly used dir)
  {
    ...
    DirDef *dir = dd;
    while (dir) {
      // printf("*** check relation %s->%s same_parent=%d
      // !%s->isParentOf(%s)=%d\n",
  ...
  for (di.toFirst(); (dir = di.current()); ++di) // foreach dir in the graph
  {
    ...
    for (udi.toFirst(); (udir = udi.current()); ++udi) // foreach used dir
    {
      const DirDef *usedDir = udir->dir();
      if ((dir != dd ||
           !udir->inherited()) && // only show direct dependendies for this dir
          (usedDir != dd ||
           !udir->inherited()) && // only show direct dependendies for this dir
          !usedDir->isParentOf(dir) && // don't point to own parent
          dirsInGraph.find(usedDir->getOutputFileBase())) // only point to nodes
                                                          // that are in the
                                                          // graph
      {
        QCString relationName;
        relationName.sprintf("dir_%06d_%06d", dir->dirCount(),
                             usedDir->dirCount());
        if (Doxygen::dirRelations.find(relationName) == 0) {
          // new relation
          Doxygen::dirRelations.append(
              relationName, new DirRelation(relationName, dir, udir));
        }
